...
function profilListesi(fDizi) {
  let yDizi = [...fDizi];

  for (let i = 0; i < yDizi.length; i++) {
    yDizi[i] = yDizi[i].profile;
  }
...
function fenomenSil(fDizi, indexD) {
  let yDizi = [...fDizi];

  yDizi.splice(indexD, 1);

  return yDizi;
}

console.log(fenomenSil(fenomenler, 3));
